...
const learningSeed = {
  거래대금: {
    id: "trading-value",
    category: "차트 지표",
    core: "거래량에 가격을 곱해 실제 돈이 얼마나 들어왔는지 보여주는 지표입니다.",
    chart: "거래량이 커도 주가가 낮으면 영향이 작을 수 있어 거래대금으로 실제 관심 규모를 확인합니다.",
    zone: "돌파 구간, 호재 마커, 매수 검토 구간에서 거래대금 증가가 같이 나오는지 봅니다.",
    why: "기관과 외국인 같은 큰 자금이 움직였는지 판단하는 데 도움이 됩니다.",
    misunderstanding: "거래량만 많으면 충분하다고 생각하지만 실제 돈의 크기도 함께 봐야 합니다.",
    scenario: "전고점을 넘을 때 거래대금이 평소보다 크면 돌파 신뢰도가 높아집니다.",
    related: ["거래량", "수급", "저항선"]
  },
  PER: {
    id: "per",
    category: "기업 가치",
    core: "주가가 회사 이익에 비해 비싼지 싼지 보는 대표 지표입니다.",
    chart: "차트에는 직접 그려지지 않지만 실적 발표, 저평가 재평가 구간과 함께 봅니다.",
    zone: "실적 개선 호재 마커와 중장기 관심 후보 구간에서 함께 확인합니다.",
    why: "성장 기대가 가격에 얼마나 반영됐는지 가늠하게 해줍니다.",
    misunderstanding: "PER이 낮으면 무조건 싸다고 보거나, 높으면 무조건 위험하다고 보는 실수가 있습니다.",
    scenario: "PER이 높아도 이익 증가가 빠르면 시장이 성장성을 먼저 반영할 수 있습니다.",
    related: ["ROE", "PBR", "실적"]
  },
  PBR: {
    id: "pbr",
    category: "기업 가치",
    core: "주가가 회사 순자산에 비해 어느 정도 평가받는지 보는 지표입니다.",
    chart: "차트에는 직접 표시되지 않지만 저평가 기대, 자산주 재평가 뉴스와 연결됩니다.",
    zone: "장기 지지선과 정책 수혜 호재가 겹치는 구간에서 참고합니다.",
    why: "자산 대비 시장 평가가 낮은지 높은지 보는 데 도움됩니다.",
    misunderstanding: "PBR이 낮다는 이유만으로 바로 반등한다고 생각하면 안 됩니다.",
    scenario: "PBR이 낮아도 업황이 나쁘면 차트가 지지선을 회복할 때까지 기다리는 편이 안전합니다.",
    related: ["PER", "ROE", "시가총액"]
  },
  ROE: {
    id: "roe",
    category: "기업 가치",
    core: "회사가 자기자본으로 얼마나 효율적으로 이익을 내는지 보여줍니다.",
    chart: "실적 발표 이후 추세 유지 여부와 함께 보며 차트에는 직접 그려지지 않습니다.",
    zone: "실적 개선 호재와 20일선 지지 구간이 함께 나올 때 참고합니다.",
    why: "높은 ROE는 좋은 기업인지 판단하는 장기 단서가 됩니다.",
    misunderstanding: "ROE가 높아도 일회성 이익이면 지속성이 약할 수 있습니다.",
    scenario: "ROE 개선이 이어지고 거래량이 붙으면 시장의 재평가 가능성을 볼 수 있습니다.",
    related: ["PER", "PBR", "실적"]
  },
  공시: {
    id: "disclosure",
    category: "뉴스와 공시",
    core: "상장사가 투자자에게 공식적으로 알리는 중요한 회사 정보입니다.",
    chart: "공시 날짜 주변의 갭 상승, 갭 하락, 거래량 급증을 함께 확인합니다.",
    zone: "호재 또는 악재 마커가 찍힌 날짜와 리스크 관리 구간에서 봅니다.",
    why: "뉴스보다 공식성이 높아 주가가 크게 반응할 수 있습니다.",
    misunderstanding: "공시 제목만 보고 좋고 나쁨을 단정하면 안 됩니다.",
    scenario: "계약 공시가 나와도 금액과 기간이 작으면 주가 반응이 제한될 수 있습니다.",
    related: ["DART", "거래정지", "악재"]
  },
  DART: {
    id: "dart",
    category: "뉴스와 공시",
    core: "금융감독원이 운영하는 전자공시 시스템입니다.",
    chart: "DART 공시가 나온 날의 캔들과 거래량 변화를 확인합니다.",
    zone: "공시 마커, 악재 마커, 리스크 관리 구간에서 원문 확인 출처로 사용합니다.",
    why: "공식 원문을 확인해 과장된 뉴스 해석을 줄일 수 있습니다.",
    misunderstanding: "요약 기사만 읽고 공시 원문을 확인하지 않는 실수가 많습니다.",
    scenario: "유상증자 공시가 나오면 원문에서 목적과 규모를 확인한 뒤 차트 반응을 봅니다.",
    related: ["공시", "거래정지", "리스크"]
  },
  일봉: {
    id: "daily-candle",
    category: "차트 기본",
    core: "하루 동안의 시가, 고가, 저가, 종가를 하나의 캔들로 보여줍니다.",
    chart: "첫 화면의 기본 차트로, 단기 매수와 매도 검토 조건을 보는 데 사용합니다.",
    zone: "매수 검토, 관망, 매도 검토 구간을 가장 촘촘하게 확인하는 화면입니다.",
    why: "오늘의 힘과 단기 추세를 가장 직관적으로 볼 수 있습니다.",
    misunderstanding: "하루 캔들 하나만 보고 큰 결론을 내리면 흔들림에 속기 쉽습니다.",
    scenario: "호재 후 긴 윗꼬리 일봉이 반복되면 매도 검토 조건을 확인합니다.",
    related: ["주봉", "월봉", "거래량"]
  },
  주봉: {
    id: "weekly-candle",
    category: "차트 기본",
    core: "한 주의 가격 흐름을 하나의 캔들로 묶어 큰 추세를 봅니다.",
    chart: "일봉보다 노이즈가 줄어 중기 지지와 저항을 확인하기 쉽습니다.",
    zone: "분할매수 검토와 장기 관망 구간에서 추세가 살아 있는지 봅니다.",
    why: "초보자가 하루 변동에 과하게 흔들리는 것을 줄여줍니다.",
    misunderstanding: "주봉이 좋다고 단기 진입 가격까지 안전하다고 착각하면 안 됩니다.",
    scenario: "일봉은 흔들려도 주봉이 20주선 위에 있으면 중기 추세는 유지될 수 있습니다.",
    related: ["일봉", "월봉", "추세"]
  },
  월봉: {
    id: "monthly-candle",
    category: "차트 기본",
    core: "한 달의 가격 흐름을 하나로 묶어 장기 방향을 봅니다.",
    chart: "장기 고점, 장기 저점, 큰 박스권을 확인할 때 사용합니다.",
    zone: "장기 저항선, 장기 지지선, 포트폴리오 관찰 후보에서 봅니다.",
    why: "단기 호재가 장기 추세를 바꿀 만큼 큰지 판단하게 해줍니다.",
    misunderstanding: "월봉만 보고 진입하면 단기 손절 기준이 너무 멀어질 수 있습니다.",
    scenario: "월봉 저항선 앞에서 일봉 과열이 나오면 추격보다 관망 조건을 봅니다.",
    related: ["일봉", "주봉", "저항선"]
  },
  손절: {
    id: "stop-loss",
    category: "리스크 관리",
    core: "예상과 다르게 움직일 때 손실을 제한하기 위해 정한 기준입니다.",
    chart: "전저점, 지지선, 이동평균선 이탈 위치에 기준을 세웁니다.",
    zone: "리스크 관리 구간에서 가장 먼저 확인해야 하는 기준입니다.",
    why: "틀렸을 때 작게 멈추는 능력이 오래 살아남는 데 중요합니다.",
    misunderstanding: "손절은 실패가 아니라 계획과 다른 움직임을 인정하는 행동입니다.",
    scenario: "20일선과 직전 저점이 동시에 깨지면 먼저 리스크 관리 기준을 확인합니다.",
    related: ["지지선", "변동성", "분할매수"]
  },
  분할매수: {
    id: "split-buy",
    category: "리스크 관리",
    core: "한 번에 사지 않고 여러 조건을 확인하며 나누어 접근하는 방법입니다.",
    chart: "하락이 멈추고 거래량이 안정되는 구간에서 나누어 검토합니다.",
    zone: "분할매수 검토 구간과 리스크 관리 구간 사이에서 특히 중요합니다.",
    why: "초보자가 한 번의 판단에 모든 비중을 싣는 위험을 줄여줍니다.",
    misunderstanding: "가격이 떨어질 때마다 무조건 물타기하는 것과 다릅니다.",
    scenario: "악재 후 음봉 거래량이 줄고 지지선이 회복될 때만 일부 검토합니다.",
    related: ["손절", "지지선", "변동성"]
  },
  추세: {
    id: "trend",
    category: "차트 기본",
    core: "가격이 일정 기간 어느 방향으로 움직이는지 보여주는 흐름입니다.",
    chart: "고점과 저점이 높아지는지, 이동평균선 위에서 움직이는지 확인합니다.",
    zone: "관망, 매수 검토, 매도 검토 구간을 나누는 가장 큰 기준입니다.",
    why: "좋은 뉴스보다 실제 가격 흐름이 유지되는지가 더 중요할 때가 많습니다.",
    misunderstanding: "하루 반등을 바로 상승 추세로 착각하면 안 됩니다.",
    scenario: "고점과 저점이 함께 높아지고 거래량이 붙으면 추세 유지 가능성이 커집니다.",
    related: ["이동평균선", "지지선", "저항선"]
  },
  저항선: {
    id: "resistance",
    category: "차트 기본",
    core: "주가가 올라가다 자주 막히는 가격대입니다.",
    chart: "전고점, 긴 윗꼬리, 거래량 둔화가 반복되는 가격에서 확인합니다.",
    zone: "관망 구간과 매도 검토 구간의 경계로 자주 쓰입니다.",
    why: "추격 매수와 돌파 확인을 구분하는 데 도움됩니다.",
    misunderstanding: "저항선을 한 번 넘었다고 완전히 안전해지는 것은 아닙니다.",
    scenario: "전고점을 종가로 넘고 거래대금이 붙으면 저항 돌파를 다시 평가합니다.",
    related: ["지지선", "거래대금", "추세"]
  },
  지지선: {
    id: "support",
    category: "차트 기본",
    core: "주가가 내려오다 자주 버티는 가격대입니다.",
    chart: "전저점, 이동평균선, 이전 돌파 가격 근처에서 확인합니다.",
    zone: "매수 검토, 분할매수 검토, 리스크 관리 구간의 기준이 됩니다.",
    why: "관심을 둘 가격과 방어 기준을 세우는 데 중요합니다.",
    misunderstanding: "지지선은 반드시 지켜지는 선이 아니라 확인해야 하는 구간입니다.",
    scenario: "20일선 지지와 거래량 증가가 함께 나오면 매수 검토 조건이 됩니다.",
    related: ["저항선", "손절", "이동평균선"]
  },
  변동성: {
    id: "volatility",
    category: "리스크 관리",
    core: "가격이 얼마나 크게 흔들리는지를 보여주는 위험의 크기입니다.",
    chart: "긴 캔들, 큰 갭, 볼린저밴드 확장, 거래량 급증으로 확인합니다.",
    zone: "리스크 관리 구간과 포트폴리오 샌드박스에서 특히 중요합니다.",
    why: "같은 수익 가능성이라도 흔들림이 크면 필요한 기준이 달라집니다.",
    misunderstanding: "많이 흔들리는 종목을 무조건 기회로만 보면 손실이 커질 수 있습니다.",
    scenario: "호재가 있어도 변동성이 급격히 커지면 비중을 작게 나누어 봅니다.",
    related: ["손절", "볼린저밴드", "분할매수"]
  },
  거래정지: {
    id: "trading-halt",
    category: "리스크 관리",
    core: "특정 사유로 주식 거래가 일시적으로 멈추는 상태입니다.",
    chart: "거래량이 끊기거나 가격 흐름이 비정상적으로 이어지지 않는 구간과 연결됩니다.",
    zone: "악재 마커와 리스크 관리 구간에서 반드시 확인합니다.",
    why: "팔고 싶어도 거래가 되지 않을 수 있어 리스크가 큽니다.",
    misunderstanding: "거래가 멈췄다고 항상 좋은 재료를 기다리는 것은 아닙니다.",
    scenario: "공시 리스크가 큰 종목은 거래정지 가능성까지 확인한 뒤 관심 후보에서 다룹니다.",
    related: ["공시", "DART", "리스크"]
  },
  시가총액: {
    id: "market-cap",
    category: "기업 가치",
    core: "회사의 전체 시장 가격을 뜻합니다.",
    chart: "차트에는 직접 보이지 않지만 대형주와 중소형주의 변동성 차이를 이해하게 해줍니다.",
    zone: "포트폴리오 샌드박스와 관심 후보 비교에서 사용합니다.",
    why: "종목 규모에 따라 움직임의 속도와 위험이 달라집니다.",
    misunderstanding: "주가가 낮으면 회사가 싸다고 생각하지만 시가총액을 함께 봐야 합니다.",
    scenario: "같은 5% 상승이라도 대형주는 큰 자금이 들어왔다는 의미일 수 있습니다.",
    related: ["PER", "PBR", "변동성"]
  },
  섹터: {
    id: "sector",
    category: "시장 분류",
    core: "비슷한 산업에 속한 기업들을 묶은 분류입니다.",
    chart: "같은 섹터 종목들이 함께 오르는지 보면 움직임의 신뢰도를 볼 수 있습니다.",
    zone: "관심 후보, 포트폴리오 샌드박스, 호재 마커에서 함께 확인합니다.",
    why: "개별 종목 이슈인지 산업 전체 흐름인지 구분하게 해줍니다.",
    misunderstanding: "섹터가 좋다고 모든 종목이 같이 오르는 것은 아닙니다.",
    scenario: "반도체 섹터가 함께 강하면 개별 호재보다 산업 수급일 가능성이 큽니다.",
    related: ["테마", "수급", "시가총액"]
  },
  테마: {
    id: "theme",
    category: "시장 분류",
    core: "시장 관심이 몰리는 이야기나 재료로 묶인 종목 그룹입니다.",
    chart: "테마가 강할 때 여러 종목의 거래량과 상승률이 동시에 커집니다.",
    zone: "검색, 관심 후보, 호재 마커에서 사용자가 흐름을 찾는 출발점입니다.",
    why: "단기 시장 관심이 어디에 있는지 빠르게 파악할 수 있습니다.",
    misunderstanding: "테마주는 재료가 사라지면 빠르게 식을 수 있다는 점을 놓치기 쉽습니다.",
    scenario: "AI 메모리 테마가 강해도 전고점을 못 넘는 종목은 관망이 더 나을 수 있습니다.",
    related: ["섹터", "거래량", "호재"]
  },
  수급: {
    id: "supply-demand",
    category: "차트 지표",
    core: "누가 사고 누가 파는지에 따라 가격에 생기는 힘입니다.",
    chart: "거래량, OBV, 외국인과 기관 흐름, 돌파 캔들을 함께 봅니다.",
    zone: "매수 검토, 매도 검토, 호재와 악재 마커를 판단할 때 사용합니다.",
    why: "뉴스가 있어도 실제 매수세가 붙지 않으면 주가가 약할 수 있습니다.",
    misunderstanding: "하루 수급만 보고 큰 추세를 단정하면 안 됩니다.",
    scenario: "기관과 외국인 매수가 이어지고 OBV가 우상향하면 상승 신뢰도가 높아집니다.",
    related: ["거래량", "OBV", "거래대금"]
  },
  OBV: {
    id: "obv",
    category: "보조 지표",
    core: "상승일과 하락일의 거래량을 누적해 수급 방향을 보는 지표입니다.",
    chart: "차트 하단 보조지표에서 가격보다 먼저 올라가는지 또는 꺾이는지 확인합니다.",
    zone: "호재 마커, 매수 검토 구간, 반대 신호 확인에서 함께 봅니다.",
    why: "가격이 쉬어도 수급이 유지되는지 확인할 수 있습니다.",
    misunderstanding: "OBV만 좋아 보인다고 바로 매수 조건이 완성되는 것은 아닙니다.",
    scenario: "가격은 횡보하지만 OBV가 올라가면 조용한 매집 가능성을 관찰합니다.",
    related: ["거래량", "수급", "MACD"]
  },
  볼린저밴드: {
    id: "bollinger-band",
    category: "보조 지표",
    core: "가격의 평균과 변동 범위를 밴드로 보여주는 지표입니다.",
    chart: "상단 밴드 돌파, 하단 밴드 이탈, 밴드 폭 확장을 확인합니다.",
    zone: "변동성 확대, 매도 검토, 리스크 관리 구간에서 참고합니다.",
    why: "가격이 평소보다 과하게 움직이는지 판단하는 데 도움됩니다.",
    misunderstanding: "상단 밴드에 닿으면 반드시 하락한다고 생각하면 강한 추세를 놓칠 수 있습니다.",
    scenario: "상단 밴드를 타고 오르지만 거래량이 줄면 추격보다 관망 조건을 확인합니다.",
    related: ["변동성", "RSI", "MACD"]
  }
};

function buildLearningTerm(term) {
  const seed = learningSeed[term] || {};
  const id = seed.id || term.toLowerCase().replace(/\s+/g, "-");
  const core = seed.core || `${term}은 주가 움직임을 차트와 함께 이해하기 위한 핵심 개념입니다.`;
  return {
    id,
    term,
    category: seed.category || "차트 학습",
    coreSummary: core,
    plainDefinition: core,
    longExplanation:
      `${term}은 단어 뜻만 외우는 것보다 실제 차트에서 어떤 행동 기준이 되는지 보는 것이 중요합니다.\n가격, 거래량, 이벤트 마커와 함께 확인하면 좋은 신호와 위험 신호를 더 쉽게 구분할 수 있습니다.\n초보자는 하나의 숫자나 뉴스로 단정하지 말고 조건이 함께 맞는지 확인하는 연습을 해야 합니다.`,
    chartUsage: seed.chart || "차트의 가격 흐름, 거래량, AI 주석, 이벤트 마커와 함께 확인합니다.",
    relatedChartZone: seed.zone || "매수 검토, 관망, 매도 검토, 리스크 관리 구간에서 관련 신호를 확인합니다.",
    whyItMatters: seed.why || "조건형 판단을 세우고 성급한 매수와 매도를 줄이는 데 도움됩니다.",
    beginnerCheck: "가격, 거래량, 기준일, 반대 신호를 함께 확인합니다.",
    caution: seed.misunderstanding || "한 가지 지표만 보고 확정 판단을 내리면 안 됩니다.",
    commonMisunderstanding: seed.misunderstanding || "좋은 숫자 하나가 곧바로 좋은 매수 조건이라고 착각하기 쉽습니다.",
    scenario: seed.scenario || `${term} 신호가 좋아 보여도 차트가 저항선을 넘지 못하면 관망 조건을 먼저 봅니다.`,
    relatedTerms: seed.related || ["거래량", "추세", "리스크"],
    exampleQuestions: [`${term}은 차트에서 어디를 보면 돼?`, `${term}을 매수 검토 조건에 어떻게 써?`],
    relatedQuestions: [`현재 ${term} 신호는 유리해?`, `${term}의 반대 신호는 뭐야?`]
  };
}

const existingLearningTerms = new Set(fallbackLearningTerms.map((item) => item.term));
fallbackLearningTerms.push(
  ...requiredLearningTerms.filter((term) => !existingLearningTerms.has(term)).map(buildLearningTerm)
);

  ...
  private static List<LearningTermDto> buildTerms() {
    return List.of(
        ...
        term(
            ...
            "거래정지",
            "리스크",
            "거래소가 특정 종목의 매매를 일정 기간 멈추는 조치입니다.",
            "투자자가 원하는 시점에 사고팔 수 없게 되므로 유동성 리스크를 크게 높입니다.",
            "거래정지 사유, 해제 예정일, 공시 원문, 재개 후 기준가와 변동성 확대 가능성을 확인하세요.",
            "거래가 멈췄다고 악재가 모두 끝난 것이 아니며, 재개 직후 가격이 크게 흔들릴 수 있습니다.",
            List.of("매매거래정지", "상장폐지", "관리종목", "유동성", "공시"),
            List.of("거래정지 종목은 언제 다시 거래돼요?", "거래정지가 나오면 무엇부터 확인해야 해요?", "거래 재개 후 바로 매수해도 되나요?")),
        term(
            "short-covering",
            "숏커버링",
            "시장",

  ...
  private static List<LearningTermDto> buildTerms() {
    return List.of(
        ...
        term(
            ...
            "이동평균선",
            "차트",
            "최근 여러 날의 평균 가격을 선으로 이어 가격 흐름을 부드럽게 보여주는 지표입니다. 5일선은 단기 흐름, 20일선은 약 한 달 평균 흐름, 60일선은 중기 흐름을 봅니다.",
            "단기 소음보다 큰 흐름을 확인할 때 도움이 되지만 이동평균선 위라고 무조건 좋은 것도, 아래라고 무조건 나쁜 것도 아닙니다.",
            "현재 가격이 20일선 위인지 아래인지, 20일선 기울기가 상승인지 하락인지, 거래량과 지지선/저항선이 같은 방향인지 확인하세요.",
            "이동평균선은 과거 가격으로 계산되므로 신호가 늦을 수 있고 거래량, 지지선, 저항선, 이벤트와 함께 봐야 합니다.",
            List.of("이평선", "5일선", "20일선", "60일선", "추세"),
            List.of("이동평균선 위에 있으면 좋은 건가요?", "5일선과 20일선은 뭐가 달라요?", "20일선 아래면 무조건 나쁜가요?")),
        term(
            "trend",
            "추세",
            "차트",
            "가격이 일정 기간 같은 방향으로 움직이는 흐름입니다.",
            "매수 검토, 관망, 매도 검토를 나눌 때 현재 가격이 상승 흐름인지, 횡보인지, 하락 흐름인지 구분하는 기준이 됩니다.",
            "5일선, 20일선, 60일선의 방향과 현재가 위치, 거래량 증가 여부를 함께 확인하세요.",
            "짧은 반등 하나만으로 하락 추세가 끝났다고 단정하면 위험합니다.",
            List.of("상승추세", "하락추세", "횡보", "이동평균선"),
            List.of("상승 추세는 어떻게 확인해요?", "횡보와 하락 추세는 어떻게 달라요?")),
        term(
            "daily-candle",
            "일봉",
            "차트",
            "하루의 시가, 고가, 저가, 종가를 하나의 캔들로 묶어 보여주는 차트입니다.",
            "단기 매수/매도 검토 조건과 이벤트 당일 가격 반응을 확인할 때 가장 자주 봅니다.",
            "일봉에서 20일선 위치, 거래량 급증, 종가가 고가와 저가 중 어디에 가까운지 확인하세요.",
            "하루 캔들 하나만 보고 중기 흐름을 확정하면 안 됩니다.",
            List.of("캔들", "OHLCV", "단기 흐름"),
            List.of("일봉에서 제일 먼저 볼 것은 뭐예요?", "일봉 급등은 계속 오르는 신호인가요?")),
        term(
            "weekly-candle",
            "주봉",
            "차트",
            "한 주의 가격 움직임을 하나의 캔들로 묶어 보는 차트입니다.",
            "일봉의 흔들림을 줄이고 몇 주 단위 추세가 유지되는지 확인하는 데 도움이 됩니다.",
            "주봉 20일선 성격의 평균 흐름, 전고점 돌파 유지, 거래량이 몇 주 연속 붙는지 확인하세요.",
            "주봉은 느리게 움직이므로 단기 이벤트 대응에는 늦을 수 있습니다.",
            List.of("중기 흐름", "캔들", "추세"),
            List.of("주봉은 언제 봐야 해요?", "일봉과 주봉이 다르면 무엇을 믿어야 해요?")),
        term(
            "monthly-candle",
            "월봉",
            "차트",
            "한 달의 가격 움직임을 하나의 캔들로 묶어 큰 흐름을 보는 차트입니다.",
            "장기 저항선, 장기 지지선, 큰 추세가 훼손됐는지 확인할 때 유용합니다.",
            "월봉에서는 급한 매수보다 장기 박스권, 이전 고점, 큰 거래대금이 붙은 달을 확인하세요.",
            "월봉이 좋아 보여도 일봉에서 과열이면 단기 진입 조건은 따로 봐야 합니다.",
            List.of("장기 흐름", "박스권", "전고점"),
            List.of("월봉은 초보자에게 왜 필요해요?", "월봉 저항선은 어떻게 봐요?")),
        term(
            "volatility",
            "변동성",
            "리스크",
        ...
        term(
            ...
            "지지선",
            "차트",
            "가격이 내려올 때 여러 번 버틴 구간입니다.",
            "분할매수 검토와 리스크 관리 기준을 나눌 때 가장 먼저 확인하는 가격대입니다.",
            "최근 저점, 거래량이 많이 붙은 가격, 20일선이나 60일선이 겹치는지 확인하세요.",
            "지지선은 반드시 지켜지는 선이 아니며 종가 기준 이탈과 거래량 증가를 함께 봐야 합니다.",
            List.of("전저점", "분할매수", "리스크 관리"),
            List.of("지지선은 어떻게 찾나요?", "지지선이 깨지면 무조건 매도인가요?")),
        term(
            "resistance-line",
            "저항선",
            "차트",
            "가격이 오를 때 여러 번 막힌 구간입니다.",
            "매수 검토 전에는 돌파 확인, 매도 검토 전에는 과열과 실패 돌파 여부를 보는 기준이 됩니다.",
            "전고점, 큰 거래대금이 나온 가격, 윗꼬리가 반복된 구간을 함께 확인하세요.",
            "저항선 돌파가 장중에만 나오고 종가가 밀리면 가짜 돌파일 수 있습니다.",
            List.of("전고점", "돌파", "매도 검토"),
            List.of("저항선 돌파는 좋은 신호인가요?", "가짜 돌파는 어떻게 구분해요?")),
        term(
            "breakout",
            "돌파",
            "차트",
